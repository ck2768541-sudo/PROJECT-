...
router.get("/attendance/weekly", getWeeklyAttendanceAnalytics);
router.get("/attendance/monthly", getMonthlyAttendanceAnalytics);
router.get("/attendance/subjects", getSubjectWiseAttendanceAnalytics);
router.get("/attendance/classes", getClassWiseAttendanceAnalytics);
